...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex h-20 shrink-0 items-end rounded-lg bg-indigo-500 p-4 md:h-52">
        {/* <AcmeLogo /> */}
      </div>
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-950 px-6 py-10 md:w-2/5 md:px-20">
          <p className='text-xl text-gray-50 md:text-3xl md:leading-normal'>
            <strong>Welcome to Huddle.</strong><br />
            The next generation of fun, conversational catch-ups
          </p>
          <Link
            href="/login"

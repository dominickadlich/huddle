...
export const floorCoverage: Coverage[] = [
  ...
  },
  {
    team: "2A",
    phone: "5-8781",
    floors: ["New dofetilide/sotalol starts"],
  ...
  },
  {
    team: "2G",
    phone: "4-3315",
    floors: ["HC4/HC5/ HC9 off-service"],
  ...
  },
  {
    team: "3M",
    phone: "8-0948",
    floors: ["64", "53 (non-surgical patients)"],
    service: "MPF, MPJ",
    shift: "weekday-day",
  },
  {
  ...
  },
  {
    team: "4A",
    phone: "8-2850",
    floors: ["SIC (26/28)", "52 (off service)"],
    service: "Trauma, Burn",
    shift: "weekday-day",
  },
  {
  ...
  },
  {
    ...
    floors: ["TICU(63) & 61/63/65 off service"],
    service: "MICU 3",
    shift: "weekday-day",
  },
  {
    ...
    floors: ["CA8 ICU", "CA8 ICU off-service"],
    service: "MICU 4",
    shift: "weekday-day",
  },
  {
  ...
  },
  {
    ...
    floors: ["HC8 (Gyn/GynONC)", "CA11 off-service"],
  ...
  },
  {
    team: "5F",
    phone: "--",
    floors: ["CA8 non-ICU", "CA11 CLN TRT"],
  ...
  },
  {
    ...
    service:
      "Surgery-Trauma (excluding Floor Trauma on 26/28), Surgery-Urology (non-ICU LOC)",
    shift: "weekday-day",
  },
  {
    team: "ED1",
  ...
  },
  {
    team: "ORE",
    phone: "8-4155",
    floors: ["BHPP (non-boarders)", "BHIR", "BHOR (Before 9 am)"],
    service: "--",
    shift: "weekday-day",
  },
  {
    team: "ORL",
    phone: "8-4155",
    floors: ["BHPP (non-boarders)", "BHIR", "BHOR (after 9 am)"],
    service: "--",
    shift: "weekday-day",
  },
  {
    ...
    phone: "8-3812",
    floors: ["HC2; New dofetilide/sotalol starts on non-cardiology teams"],
    service: "--",
    shift: "weekday-day",
  },
  {
    team: "COD",
    phone: "4-3350",
    floors: ["CAIR", "CAOR", "CAPP (non-boarders)"],
    service: "--",
    shift: "weekday-day",
  },
  {
    team: "PAC",
    phone: "8-0496/8-4298",
    floors: ["Preoperative Assessment Clinic"],
    service: "--",
    shift: "weekday-day",
  },
  {
  ...
  },
  {
    team: "3EA",
    phone: "--",
    floors: ["BH15", "18", "41", "45", "46", "66", "Rehab"],
    shift: "weekday-evening",
  },
  {
    team: "3EB",
    phone: "--",
    floors: ["42", "53", "62", "64", "HC7", "CA6 Medicine pts"],
    shift: "weekday-evening",
  },
  {
    team: "4E",
  ...
  },
  {
    team: "1A",
    phone: "8-4035 or 8-5681",
    floors: ["PEDS-44", "PIC-44", "LDR-54 55(NICU)", "56MB", "56N"],
    shift: "weekend",
  },
  {
    team: "2A",
  ...
  },
  {
    team: "4B",
    phone: "--",
    floors: ["MICU 1", "2", "3 (off-svc 61", "63", "65)"],
    shift: "weekend",
  },
  {
    team: "5A",
    phone: "--",
    floors: ["Hematology", "Oncology", "CA8", "CA11", "Onc cs"],
    shift: "weekend",
  },
  {
    team: "5B1",
    phone: "--",
    floors: ["Med-BMT Allo", "MPU", "HC8"],
    shift: "weekend",
  },
  {
    team: "5B2",
    phone: "--",
    floors: ["Med-Acute Leukemia", "MPP", "CA10"],
    shift: "weekend",
  },
  {
    team: "5B3",
    phone: "--",
    floors: ["Med-BMT and Cell Therapy", "MPS", "CA9", "Heme cs"],
    shift: "weekend",
  },
  {
    team: "ED1, ED2",
...
export function findCoverageByFloor(
  ...
  return floorCoverage.filter(
    (coverage) =>
      coverage.shift === shift &&
      coverage.floors.some(
        (floor) =>

...
export default function EditExtensionForm({
    ...
    const [state, formAction] = useActionState(updateExtensionWithId, initialState);
    ...
    return (
     <form action={formAction}>
            <div className="rounded-md bg-gray-50 p-4 md:p-6">
                {/* Extension Name */}
                <div className="mb-4">
                    <label htmlFor="siteName" className="mb-2 block text-sm font-medium text-black">
                        Site Name
                    </label>
                ...
                {/* Extension Number */}
                <div className="mb-4">
                    <label htmlFor="siteNumber" className="mb-2 block text-sm font-medium text-black">
                        Site Number
                    </label>
                    <div className="relative">
                        <input
